...
export const MODELS: EmbeddingModel[] = [
  { id: 'text-embedding-ada-002', label: 'Ada 002', dimensions: 1536, released: 'Dec 2022', note: 'Legacy' },
  { id: 'text-embedding-3-small', label: 'Embedding 3 Small', dimensions: 1536, released: 'Jan 2024', note: 'Cost-effective' },
  { id: 'text-embedding-3-large', label: 'Embedding 3 Large', dimensions: 3072, released: 'Jan 2024', note: 'Most capable' },
];
...
export function getModelReleased(id: string): string | undefined {
  return MODELS.find((m) => m.id === id)?.released;
}
